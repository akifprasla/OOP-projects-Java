...
public final class Complex {
	...
	public Complex add(Complex c) {
		...
		/*
		 * double real = this.real + c.real; double imag = this.imag + c.imag;
		 */
		Complex newComplex = new Complex(this.real+c.real, this.imag + c.imag);
		return newComplex;
	}
	...
	public int hashCode() {
		...
		double re = 9999 * this.real;
		double im = 99 * this.imag;
		int sum = (int) (re + im);
		return sum;
	}
	...
	public static Complex valueOf(String s) {
		...
		String sign = "";
		String temp = (parts.get(2)).substring(0, parts.get(2).length()-1);
		...
		double im = Double.valueOf(sign + temp);
